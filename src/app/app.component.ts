...
export class AppComponent implements OnInit {
  ...
  NgxCookieConsent() {
    ...
    this.ccService.getConfig().content['cookiePolicyHref'] =
      content.cookiePolicyHref
    this.ccService.getConfig().content['privacyPolicyLink'] =
      content.privacyPolicyLink
    this.ccService.getConfig().content['privacyPolicyHref'] =
      content.privacyPolicyHref

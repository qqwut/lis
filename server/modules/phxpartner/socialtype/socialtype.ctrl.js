...
var socialType = require('../../../model/socialType.js');
// var companyMod = require('../../../model/company.js');
// var userGroupMod = require('../../../model/userGroup.js');
var logger = require('../../../utils/logger');

exports.getSocialTypeList = function (req, res) {
    logger.info('get Social Type list');
    var ret = {
        responseCode: 200,
    ...
    .find(filter, null, {
        ...
        logger.info('get Social Type list size :: ' + result.length);
        ret.data = result;

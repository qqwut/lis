...
var shopSegment = require('../../../model/shopSegment.js');
// var companyMod = require('../../../model/company.js');
// var userGroupMod = require('../../../model/userGroup.js');
var logger = require('../../../utils/logger');

exports.getshopsegmentList = function (req, res) {
    logger.info('get Shop Segment list');
    var ret = {
        responseCode: 200,
    ...
    .find(filter, null, {
        ...
        //     createdDate: -1
        // }
    }).select(['-_id','code','name','channelType']).exec( function (err, result) {
        if (err) {
            console.error(err);
        ...
        logger.info('get shop Segment list size :: ' + result.length);
        ret.data = result;

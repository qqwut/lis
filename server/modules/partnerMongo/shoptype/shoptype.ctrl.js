...
var shopType = require('../../../model/shopType.js');
// var companyMod = require('../../../model/company.js');
// var userGroupMod = require('../../../model/userGroup.js');
var logger = require('../../../utils/logger');

exports.getShopTypeList = function (req, res) {
    logger.info('get Shop Type list');
    var ret = {
        responseCode: 200,
    ...
    .find(filter, null, {
        ...
        logger.info('get shop Type list size :: ' + result.length);
        ret.data = result;

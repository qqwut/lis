...
var personPhoneType = require('../../../model/personPhoneType.js');
// var companyMod = require('../../../model/company.js');
// var userGroupMod = require('../../../model/userGroup.js');

exports.getPersonPhoneTypeList = function (req, res) {
    console.log('get Person Phone Type list');
    var ret = {
        responseCode: 200,
    ...
    .find(filter, null, {
        ...
        console.log('get Person Phone Type list size :: ' + result.length);
        ret.data = result;

...
exports.getZipCodeCompany = function (req, res) {
    logger.info('get zipcode data');
...
exports.getZipCodeALL = function (req, res) {
    logger.info('get zipcode for asc');
    var ret = {
        responseCode: 200,
        responseMessage: 'Success'
    };
    ...
    var zipCode = req.query.zipCode;
    var subRegion = req.query.subRegion;
    var zipCodeId = req.query.zipCodeId;
        ...
        if (permission && permission[0]) {
            ...
            if (retail && retail[0] && retail[0].code && retail[0].code.length > 0) { //case retail
                ...
                provinceMod.aggregate(aggregate, function (err, province) {
                    ...
                    if (zipCodeId && zipCodeId.length > 0) {
                        if (zipCodeId.indexOf('*') > 0) {
                            var regexValue = utils.regexMongoStartWith(zipCodeId);
                            condition.zipCodeId_key2 = {
                                $regex: new RegExp(regexValue)
                            };
                        } else {
                            condition.zipCodeId_key2 = {
...
exports.getZipCodeSap = function (req, res) {
    logger.info('get zipcode for sap');
    var filter = {};
    var name = '';
    var zipCodeId = req.query.zipCodeId;
    ...
    try {
        ...
        .find({'zipCodeId_key0': zipCodeId},{
            ...
            if (err) {
                ...
                logger.info('get zipcode for sap size :: ' + result.length);
                ret.data = result;
                res.json(ret);
            }
        }

require('dotenv').config({
    ...
    sample: require('path').join(__dirname, './env/.env'),
});
...
cfg.authS3 = process.env.AUTHS3 || process.env.LOCAL_AUTHS3;
...
cfg.SECRET = process.env.JWT_SECRET || process.env.LOCAL_JWT_SECRET;
